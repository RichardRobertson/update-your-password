...
function copyStatic() {
    return gulp
        .src(["./LICENSE.md", "./README.md", "./lang/*", "./scripts/**/*"], { base: "./" })
...
function copyDynamic() {
    ...
    return gulp
        ...
        .pipe(
            gulpJsonModify({
                key: "download",
                value: `https://github.com/RichardRobertson/update-your-password/releases/download/v${packageJson.version}/update-your-password-v${packageJson.version}.zip`,
            })
        )
        .pipe(gulp.dest("./build/"));
}
